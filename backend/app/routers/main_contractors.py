...
def list_main_contractors(db: Session = Depends(get_db), current_user: User = Depends(require_internal_module("contractors", "view"))):
...
def get_main_contractor(main_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_internal_module("contractors", "view"))):
...
def delete_main_contractor(main_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_internal_module("contractors", "delete"))):
