...
def create_guard_rate(guard_id: int, data: GuardRateCreate, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "guard_rates_manage"))):
...
def list_guard_rates(guard_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "guard_rates_view"))):
...
def delete_guard_rate(rate_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "guard_rates_delete"))):
...
def create_site_rate(site_id: int, data: SiteRateCreate, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "site_rates_manage"))):
...
def list_site_rates(site_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "site_rates_view"))):
...
def delete_site_rate(rate_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_module("company", "site_rates_delete"))):
