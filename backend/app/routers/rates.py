...
def create_guard_rate(guard_id: int, data: GuardRateCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def list_guard_rates(guard_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def delete_guard_rate(rate_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def create_site_rate(site_id: int, data: SiteRateCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def list_site_rates(site_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
...
def delete_site_rate(rate_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
