...
MODULE_SEED: tuple[tuple[str, str, str, str, int, str], ...] = (
    ...
    ("assignments", "Assignments", "ClipboardList", "/assignments", 22, "sectionScheduling"),
    ("special_days", "Special days", "Calendar", "/settings/special-days", 23, "sectionScheduling"),
    # Field operations — what happens on the ground once the rota is out.
    ("sites", "Sites", "MapPin", "/sites", 30, "sectionField"),
    ("patrol", "Patrol", "MapPinned", "/patrol", 31, "sectionField"),
    ("lone_worker", "Lone worker", "ShieldAlert", "/lone-worker", 32, "sectionField"),
    ("my_portal", "My workspace", "UserCircle", "/my-portal", 33, "sectionField"),
    ("tasks", "Tasks", "ListChecks", "/tasks", 34, "sectionField"),
    # Safety & compliance — the records a regulator or insurer asks for.
    ("incidents", "Incidents", "AlertTriangle", "/incidents", 40, "sectionSafety"),
    ("accident_reports", "Accident reports", "ClipboardCheck", "/accident-reports", 41, "sectionSafety"),
    ("occurrence_sheets", "Occurrence sheets", "NotebookPen", "/occurrence-sheets", 42, "sectionSafety"),
    ("roles", "Roles & permissions", "Shield", "/settings/roles", 43, "sectionSafety"),
    # Clients & sales.
    ("clients", "Clients", "Building2", "/clients", 50, "sectionSales"),
    ("client_portal", "Client portal", "Building2", "/client-portal", 51, "sectionSales"),
