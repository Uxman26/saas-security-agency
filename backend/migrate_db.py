...
def run():
    ...
    alters = [
        ...
        # HR module: the Employee Profile tabs (Personal, Employment, Termination) and
        # the document metadata the Documents screens show.
        ("guards", "personal_email", "TEXT"),
        ("guards", "home_phone", "TEXT"),
        ("guards", "work_extension", "TEXT"),
        ("guards", "covid_vaccinated", "TEXT"),
        ("guards", "medical_notes", "TEXT"),
        ("guards", "contract_type", "TEXT"),
        ("guards", "working_location", "TEXT"),
        ("guards", "reports_to", "TEXT"),
        ("guards", "probation_required", "INTEGER DEFAULT 0"),
        ("guards", "notice_period", "TEXT"),
        ...
        ("guards", "external_reference", "TEXT"),
        ("guards", "employee_notes", "TEXT"),
        ("guards", "sickness_entitlement_hrs", "INTEGER"),
        ("guards", "sickness_entitlement_mins", "INTEGER"),
        ("guards", "termination_date", "TEXT"),
        ("guards", "termination_reason", "TEXT"),
        ("guards", "termination_notes", "TEXT"),
        ("guard_documents", "folder", "TEXT"),
        ("guard_documents", "file_size", "INTEGER"),
        ("guard_documents", "mime_type", "TEXT"),
        ("guard_documents", "uploaded_by_user_id", "INTEGER REFERENCES users(id)"),
        ("guard_documents", "follow_up_date", "TEXT"),
        ("guard_documents", "visible_to_employee", "INTEGER NOT NULL DEFAULT 1"),
        ("guard_documents", "requires_acceptance", "INTEGER NOT NULL DEFAULT 0"),
    ]
