...
/**
 * Ibelick-style mouse-follow spotlight (21st.dev dependency).
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'from-orange-200 via-orange-100 to-transparent dark:from-zinc-50 dark:via-zinc-100 dark:to-zinc-200',
